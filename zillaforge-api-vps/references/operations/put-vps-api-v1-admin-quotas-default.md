# PUT /vps/api/v1/admin/quotas/default

**Resource:** [system_quota](../resources/system-quota.md)
**set default quotas**
**Operation ID:** `put--vps-api-v1-admin-quotas-default`

Sets the quota limits that are used as defaults when creating projects.
-1 means unlimited.
